...
packet_loss=sys.maxsize
entries=[100,200,600,700,1000,5000,7000,9000,15000,20000,35000,50000,65000]
...
while(timer!=700):
    ...
    # k1= [port_stat_table.make_key([gc.KeyTuple('$DEV_PORT', port15)]) ]
