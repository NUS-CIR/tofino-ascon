...
group.add_argument('--tf1_rpp', dest='rpp', type=int, choices=[1, 2], help='Rounds per pass for Tofino 1')
group.add_argument('--tf2_rpp', dest='rpp', type=int, choices=[1, 2, 3, 4], help='Rounds per pass for Tofino 2')
