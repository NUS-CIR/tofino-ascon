...
//Final layer--for obtaining hdr.s4
    ...
    apply {
        ...
        if(hdr.ascon.curr_round==0x24){
            // hdr.ethernet.ether_type=ETHERTYPE_NORM;
            // ig_tm_md.ucast_egress_port =(bit<9>)hdr.ascon.dest_port;
            hdr.ascon_out.o4=hdr.ascon.s0[63:48];
            hdr.ascon_out.o5=hdr.ascon.s0[47:32];
            hdr.ascon_out.o6=hdr.ascon.s0[31:16];
            hdr.ascon_out.o7=hdr.ascon.s0[15:0];
        ...
        if(hdr.ascon.curr_round==0x30){
            // hdr.ethernet.ether_type=ETHERTYPE_NORM;
            // ig_tm_md.ucast_egress_port =(bit<9>)hdr.ascon.dest_port;
            hdr.ascon_out.o8=hdr.ascon.s0[63:48];
            hdr.ascon_out.o9=hdr.ascon.s0[47:32];
            hdr.ascon_out.o10=hdr.ascon.s0[31:16];
            hdr.ascon_out.o11=hdr.ascon.s0[15:0];
            //reg.write(0,0xb);
        }

        if(hdr.ascon.curr_round==0x3c){
            // hdr.ethernet.ether_type=ETHERTYPE_NORM;
            // ig_tm_md.ucast_egress_port =(bit<9>)hdr.ascon.dest_port;
            hdr.ascon.s4=hdr.ascon.s0;
            hdr.ascon.s0[63:48]=hdr.ascon_out.o0;
            hdr.ascon.s0[47:32]=hdr.ascon_out.o1;
            hdr.ascon.s0[31:16]=hdr.ascon_out.o2;
            hdr.ascon.s0[15:0]=hdr.ascon_out.o3;
            hdr.ascon.s0[63:48]=hdr.ascon_out.o4;
            hdr.ascon.s0[47:32]=hdr.ascon_out.o5;
            hdr.ascon.s0[31:16]=hdr.ascon_out.o6;
            hdr.ascon.s0[15:0]=hdr.ascon_out.o7;
            hdr.ascon.s0[63:48]=hdr.ascon_out.o8;
            hdr.ascon.s0[47:32]=hdr.ascon_out.o9;
            hdr.ascon.s0[31:16]=hdr.ascon_out.o10;
            hdr.ascon.s0[15:0]=hdr.ascon_out.o11;
            
            // hdr.ascon.s2[63:32]=hdr.ascon_out.o4;
            // hdr.ascon.s2[31:0]=hdr.ascon_out.o5;

            ig_tm_md.ucast_egress_port =(bit<9>)0x9;
            //reg.write(0,0xb);
            //normal 64 bit, 32 bit with ++ with in_hash and w/o don't work PHV exhausted
        }
        else{
