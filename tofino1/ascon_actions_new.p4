  //a fixed initialization stage
    ...
    action start_sbox_1 () {
        meta.t0 = hdr.ascon.s0 ^ (~hdr.ascon.s1 & hdr.ascon.s2);
        meta.t1 = hdr.ascon.s1 ^ (~hdr.ascon.s2 & hdr.ascon.s3);
        meta.t2 = hdr.ascon.s2 ^ (~hdr.ascon.s3 & hdr.ascon.s4);
        meta.t3 = hdr.ascon.s3 ^ (~hdr.ascon.s4 & hdr.ascon.s0);
        meta.t4 = hdr.ascon.s4 ^ (~hdr.ascon.s0 & hdr.ascon.s1);
    }
