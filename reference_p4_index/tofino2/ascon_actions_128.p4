  //a fixed initialization stage
    ...
    action abs_input_1(){
        ...
        hdr.ascon.s0= hdr.ascon.s0^ hdr.payload_128.input_str[127:64];
    	// routing_decision();
	}
    action abs_input_2(){
        hdr.ascon_out.o0=hdr.ascon.s0;
    ...
    action abs_input_3(){
        hdr.ascon.s0= hdr.ascon.s0^ hdr.payload_128.input_str[63:0];
    ...
    action tag(){
            // hdr.ascon.s3=hdr.ascon.s3 ^ K_0; 
            // hdr.ascon.s4 =hdr.ascon.s4 ^ K_1;
            hdr.ascon_tag.tag0=hdr.ascon.s3 ^ K_0;
            hdr.ascon_tag.tag1=hdr.ascon.s4 ^ K_1;
