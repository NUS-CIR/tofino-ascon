...
const bit<128> AD = 0x000102030405060708090A0B0C0D0E0F;
...
{   
    ...
    apply {
        ...
        if(hdr.ascon.curr_round==0x12){
            hdr.ascon.s0= hdr.ascon.s0^ AD[63:0];
        }
        ...
        // check for final round(47th round) after tag finalization
        if(hdr.ascon.curr_round==0x2f){
            ig_tm_md.ucast_egress_port[8:7] = ig_intr_md.ingress_port[8:7];
