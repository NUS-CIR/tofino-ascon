  //a fixed initialization stage
    ...
    action abs_input_1(){
        ...
        hdr.ascon.s0= hdr.ascon.s0^ hdr.payload_192.input_str[191:128];
    	// routing_decision();
	}
    action abs_input_2(){
        hdr.ascon_out.o0=hdr.ascon.s0;
    ...
    action abs_input_3(){
        hdr.ascon.s0= hdr.ascon.s0^ hdr.payload_192.input_str[127:64];
    ...
    action abs_input_5(){
        hdr.ascon.s0= hdr.ascon.s0^ hdr.payload_192.input_str[63:0];
